...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODEL" | "DAILY_TOKEN_CAP" | "PER_INSTALL_DAILY">> {}
}
